...
const Search = ({ videos }: { videos: Video[] }) =>  {
    ...
    const accounts = isAccounts === true ? 'border-b-2 border-black' : 'text-gray-400';
    const isVideos = !isAccounts === true ? 'border-b-2 border-black' : 'text-gray-400';
  ...
  return (
    <div className='w-full'>
       <div className='flex gap-10 mb-10 mt-10 border-b-2 border-gray-200 bg-white w-full'>
          <p onClick={() => setIsAccounts(true)} className={`text-xl font-semibold cursor-pointer mt-2 ${accounts}`}>Accounts</p>
