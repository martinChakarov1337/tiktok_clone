        ...
        <div className='bg-white w-[60%] rounded-lg xl:h-[80vh] flex gap-6 flex-wrap justify-between items-center p-14 pt-6'>
            <div>
                ...
                <div className='border-dashed rounded-xl border-4
                 ...
                 items-center outline-none mt-10 w-[260p] h-[460px]
                 p-10 cursor-pointer hover:border-red-300
                 hover:bg-gray-100'>
                    {isLoading ? (
                        <p>Uploading...</p>
                    ) : (
            ...
            <div className='flex flex-col gap-3 pb-10'>
                    ...
                    <div className='flex gap-6 mt-10'>
                        <button className='border-gray-300 border-2 text-md font-medium p-2 rounded w-28 lg:w-44 outline-none' onClick={() => {}} type='button'>
                            Discard
                        </button>
                        <button className='bg-[#F51997] text-white border-2 text-md font-medium p-2 rounded w-28 lg:w-44 outline-none' onClick={handlePost} type='button'>
                            Post
                        </button>
                    </div>
            </div>
